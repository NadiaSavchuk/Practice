...
const Rozklad = ({route}) => {
  ...
  switch (route.params.rozklad.img) {
    ...
    case 'inf_4.jpg': imgName = require('../assets/inf_4.jpg'); break;
    ...
    case 'kib_4.jpg': imgName = require('../assets/kib_4.jpg'); break;
  ...
  return (
    ...
    <Text style={styles.txt}> РОЗКЛАД ЗАНЯТЬ 02.11 - 07.11 </Text>
